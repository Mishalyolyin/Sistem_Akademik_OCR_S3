    ...
    <div class="animate-fade-in-up">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-xl p-6 border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-200">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <a href="{{ route('admin.payments.rpl', ['status' => 'pending']) }}" class="block text-2xl font-bold text-gray-800 hover:underline">{{ $rplStats['waiting_verification'] }}</a>
                        @if(($rplStats['waiting_verification_munaqosah'] ?? 0) > 0)
                            <a href="{{ route('admin.payments.munaqosah.rpl', ['status' => 'pending']) }}" class="text-[10px] font-semibold text-amber-600 hover:underline">+{{ $rplStats['waiting_verification_munaqosah'] }} di Munaqosah</a>
                        @endif
                        @if(($rplStats['waiting_verification_kerjasama'] ?? 0) > 0)
                            <a href="{{ route('admin.payments.kerjasama.rpl', ['status' => 'pending']) }}" class="block text-[10px] font-semibold text-amber-600 hover:underline">+{{ $rplStats['waiting_verification_kerjasama'] }} di Kelas Kerjasama</a>
                        @endif
                    </div>
                    <a href="{{ route('admin.payments.rpl', ['status' => 'pending']) }}" class="p-2 bg-red-50 rounded-lg text-red-600 hover:bg-red-100 transition-colors">
            ...
            <div class="bg-white rounded-xl p-6 border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-200">
                <div class="flex justify-between items-start">
                    <div>
                        <p class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Dokumen Belum Lengkap</p>
                        <a href="{{ route('admin.students.rpl', ['kelengkapan' => 'belum']) }}" class="block text-2xl font-bold text-gray-800 hover:underline">{{ $rplStats['documents_incomplete'] }}</a>
                    </div>
                    <a href="{{ route('admin.students.rpl', ['kelengkapan' => 'belum']) }}" class="p-2 bg-orange-50 rounded-lg text-orange-600 hover:bg-orange-100 transition-colors">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-xl p-6 border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-200">
                <div class="flex justify-between items-start">
                    <div>
                        <p class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Menunggu Verifikasi</p>
                        <a href="{{ route('admin.payments.reguler', ['status' => 'pending']) }}" class="block text-2xl font-bold text-gray-800 hover:underline">{{ $regulerStats['waiting_verification'] }}</a>
                        @if(($regulerStats['waiting_verification_munaqosah'] ?? 0) > 0)
                            <a href="{{ route('admin.payments.munaqosah.reguler', ['status' => 'pending']) }}" class="text-[10px] font-semibold text-amber-600 hover:underline">+{{ $regulerStats['waiting_verification_munaqosah'] }} di Munaqosah</a>
                        @endif
                    </div>
                    <a href="{{ route('admin.payments.reguler', ['status' => 'pending']) }}" class="p-2 bg-red-50 rounded-lg text-red-600 hover:bg-red-100 transition-colors">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl p-6 border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-200">
                <div class="flex justify-between items-start">
                    <div>
                        <p class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Dokumen Belum Lengkap</p>
                        <a href="{{ route('admin.students.reguler', ['kelengkapan' => 'belum']) }}" class="block text-2xl font-bold text-gray-800 hover:underline">{{ $regulerStats['documents_incomplete'] }}</a>
                    </div>
                    <a href="{{ route('admin.students.reguler', ['kelengkapan' => 'belum']) }}" class="p-2 bg-orange-50 rounded-lg text-orange-600 hover:bg-orange-100 transition-colors">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                    </a>
                </div>
            </div>
