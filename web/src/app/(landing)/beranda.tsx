      ...
      <footer className="relative border-t border-border/60 px-6 py-10">
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-2 text-center">
          ...
          <p className="text-sm text-muted-foreground">
            Program Doktor Pendidikan Agama Islam · Universitas Islam Sultan Agung
          </p>
          <p className="text-xs text-muted-foreground/70">
            Sistem pembayaran internal. Pertanyaan seputar tagihan disampaikan ke
            bagian keuangan program studi.
          </p>
        </div>
      </footer>
    </div>
  ...
  return (
    <section className="mx-auto max-w-6xl px-6 pt-20 pb-24 text-center sm:pt-28">
      ...
      <p className="mx-auto mt-5 max-w-2xl text-base text-pretty text-muted-foreground sm:text-lg">
        Seluruh tagihan Program Doktor Pendidikan Agama Islam ada di satu tempat.
        Unggah bukti transfer dari mana saja — sistem membacanya sendiri, dan
        status pembayaran Anda terbarui tanpa perlu menunggu jam kerja.
      </p>
